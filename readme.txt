...
Tags: store locator, google map, store google map, store map, Zotabox
...
+ Use customizable tab or embed in your site
+ Simple customizable popup with zoomable Google Maps
+ Ideal for 1 location.  Driving directions available
...
<li>Search for 'Store Locator with Google Map'</li>
...
<ol>
<li>Upload the store-locator-with-google-map folder to the /wp-content/plugins/ directory</li>
